...
public class TraceTest {
    ...
    private void asyncCallableInvokeTest() throws InterruptedException {
        ...
        TestCase.assertEquals("doSomething", next.get(2).getMethodName());
        ...
        TestCase.assertEquals("doSomething", next.get(3).getMethodName());
        ...
        TestCase.assertEquals("doSomething", next.get(4).getMethodName());
    ...
    private void asyncRunnableInvokeTest() throws InterruptedException {
        ...
        TestCase.assertEquals("run", next.get(1).getMethodName());
